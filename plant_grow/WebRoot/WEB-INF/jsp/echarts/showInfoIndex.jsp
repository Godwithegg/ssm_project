...
<head>
         ...
         success : function(result) {
	         ...
	         if (result != null && result.length > 0) {
	                for(var i=0;i<result.length;i++){   
	                   ...
	                   tems.push(result[i].temperature);		//挨个取出温度、湿度、压强等值并填入前面声明的温度、湿度、压强等数组
	                   hums.push(result[i].moisture);
	                   pas.push(result[i].production);
	...
	<a href="${pageContext.request.contextPath }/crop/queryStatus.action">返回</a>	
	</body>
</html>