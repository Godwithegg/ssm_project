			...
			<div class="col-md-4 myCenter">
				<ul class="nav nav-tabs">
					<li class="nav-item col-md-6">
						<a href="#east" class="nav-link active" data-toggle="tab">登陆</a>
					</li>
					<li class="nav-item col-md-6">
						<a href="#west" class="nav-link" data-toggle="tab">注册</a>
					</li>
				</ul>
			</div>
										...
										<tr>
											<td>
												...
												<div class="input-group row py-3">
													<span class="input-group-addon col-md-4">密码:</span> <input
														class="form-control col-md-8" name="password"
														type="password" maxlength="15" required />
												</div>
											</td>
										</tr>
										<tr>
											<td colspan="2" align="center" height="50px"><input
												class="btn btn-primary" type="submit" value="登陆" />
