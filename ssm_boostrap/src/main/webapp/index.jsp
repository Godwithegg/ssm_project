...
%>
<!-- web路径
	不以/开始的相对路径，找资源，是以当前资源的路径为标准的，经常容易出问题
	以/开始的相对路径，找资源，以服务器的路径为标准(http://localhost:3306)；需要加上项目名才能找到
...
<body>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control"
									id="email_update_input" placeholder="email@danhuang.com">
				...
				<div class="modal-body">
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control"
									id="email_add_input" placeholder="email@danhuang.com">
								<span class="help-block"></span>
							</div>
						</div>
						<div class="form-group">
	...
	<script type="text/javascript">
		...
		$("#emp_save_btn")
				.click(
						function() {
							...
							//1.判断之前的ajax用户名校验是否成功，如果成功了才往下继续走
		...
		//1.我们是按钮创建之前就绑定了这个事件，所有是绑定不上的
		//1可以在创建按钮的时候绑定 2绑定点击，.live()
