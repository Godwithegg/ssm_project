...
<script type="text/javascript">
	...
	function showRep() {
		document.itemsForm.action = "${pageContext.request.contextPath}/echarts/reposity.action";
		document.itemsForm.submit();
	}
</script>
<style type="text/css">
		...
		<form name="itemsForm"
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading">
					查找商品<input name="statusCustom.name" /> <input type="button"
						class="btn-success" value="查询" onclick="queryItems()" /> <input
						type="button" class="btn-info" value="数据展示" onclick="playItems()">
						<input type="button" class="btn-info" value="库存总类" onclick="showRep()">
				</div>
				<table class="table">
					<thead>
						<tr class="active">
